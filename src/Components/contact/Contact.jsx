...
const Contact = () => {
  ...
  return (
    <section id='contact' data-reveal="fade-up">
      <h2>Contact Me</h2>
      <div className="container contact_container" data-reveal="fade-up">
        <div className="contact_options">
          <article className='contact_option' data-reveal="fade-up">
        ...
        <form ref={form} onSubmit={sendEmail} data-reveal="fade-up">
          <input type="text" name="name" placeholder='Your Full Name' required />
          <input type="email" name="email" placeholder='Your Email' required />
          <textarea name="message" rows="7" placeholder='Your Message' required></textarea>
          <button type="submit" className='btn btn-primary' data-ripple>Send Message</button>
        </form>
      </div>
    </section>
  )
