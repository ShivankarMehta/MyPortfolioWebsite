const translations = {
  en: {
    ...
    nav: {
      links: ['Home', 'Featured Projects', 'Case Studies', 'About', 'Experience', 'Skills', 'Writing', 'GitHub', 'Achievements', 'Contact'],
      contact: "Let's Talk",
      ...
      jobs: [
        {
          ...
          bullets: [
            ...
            'Built CHiE (Comachi Hyper Intelligence Encyclopedia), a company-scoped document-intelligence platform with resumable multi-GB PDF ingestion, token-bounded pgvector retrieval, durable jobs, grounded AI chat, and Excel Macro AI.',
    ...
    projects: {
      ...
      view: 'View project',
      modules: [
        ['CHiE — Comachi Hyper Intelligence Encyclopedia', 'Standard Force Corporation', 'Enterprise document-intelligence platform for resumable multi-GB PDF ingestion, company-scoped knowledge, token-bounded semantic search, grounded AI chat, and Excel Macro AI workflows.'],
        ...
        ['Business Database MCP Server', 'Standard Force Corporation', 'Read-only MCP and REST API server that safely answers bilingual natural-language questions across multiple operational databases without generating ad hoc SQL.'],
  ...
  ja: {
    ...
    nav: { links: ['Home', 'Featured Projects', 'Case Studies', 'About', 'Experience', 'Skills', 'Writing', 'GitHub', 'Achievements', 'Contact'], contact: 'Let us talk', language: 'Switch to English', themeLight: 'Light theme', themeDark: 'Dark theme' },
    header: {
    ...
    work: { status: 'RUNNING', kicker: 'Experience', title: 'Jobs and internships.', jobs: [ { role: 'Software Developer / System Engineer', location: 'Japan | On-site', dates: 'Oct 2024 - Present', bullets: ['Architected a distributed ETL pipeline consolidating multiple remote MySQL databases into a centralized warehouse through SSH2 tunneling and cron-based synchronization.', 'Built CHiE (Comachi Hyper Intelligence Encyclopedia), a company-scoped document-intelligence platform with resumable multi-GB PDF ingestion, token-bounded pgvector retrieval, durable jobs, grounded AI chat, and Excel Macro AI.', 'Delivered a Construction Management System across 5 client organizations and a Next.js dashboard with Redis caching, QR logistics tracking, and reporting exports.', 'Managed CI/CD with Docker and Git on AlmaLinux servers, reducing deployment time by 60%.'] }, { role: 'Full Stack Developer Intern', location: 'Omura, Nagasaki, Japan', dates: 'May 2023 - Sep 2024', bullets: ['Designed and implemented a supply chain dashboard for 3 internal teams with ReactJS, NodeJS, and MySQL.', 'Integrated Nivo and Wijmo visualizations into an existing Laravel project, reducing manual reporting time by 50%.'] }, { role: 'Frontend Developer Intern', location: 'India | Remote', dates: 'Jun 2022 - Jan 2023', bullets: ['Developed a responsive ReactJS Sales Management System used by 200+ users.', 'Built tutor selection and matching modules for Fynii EduTech, supporting 500+ student-teacher pairings.'] } ] },
    projects: { status: 'DEPLOYED', kicker: 'Projects', title: 'Selected project highlights.', view: 'View project', modules: [['CHiE — Comachi Hyper Intelligence Encyclopedia', 'Standard Force Corporation', 'Enterprise document-intelligence platform for resumable multi-GB PDF uploads, bounded-memory streaming ingestion, company-scoped semantic search, and token-budgeted grounded AI chat.'], ['Distributed ETL Pipeline', 'Standard Force Corporation', 'SSH2 tunneling and cron synchronization pipeline consolidating multiple remote MySQL databases into a central warehouse.'], ['Construction Management System', 'Standard Force Corporation', 'Operational platform for 5 client organizations with real-time budget alerts, financial tracking, and compliance monitoring.'], ['Business Database MCP Server', 'Standard Force Corporation', 'Read-only MCP and REST API server that safely answers bilingual natural-language questions across multiple operational databases without generating ad hoc SQL.'], ['Dashboard and QR Logistics System', 'Standard Force Corporation', 'Next.js operational dashboard with Redis caching, visual reporting, Excel exports, and QR-based logistics tracking.'], ['Supply Chain Dashboard', 'LTU Corporation', 'Full-stack dashboard for 3 internal teams with ReactJS, NodeJS, MySQL, and Laravel reporting integrations.'], ['Automated Online Classroom Platform', 'HACKFEST 2022 Top 5', 'Video classroom platform with chat, attendance automation, transcription, and ML-based attention detection for 50+ participants.']] },
